    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (OrderDetailContext context = new OrderDetailContext())
            {
               ...
               {
                    new Products{ProductName="Milk",InstockQty=100,UnitPrice=4.00},
                    new Products{ProductName="Eggs",InstockQty=100,UnitPrice=3.00},
                    new Products{ProductName="Bread",InstockQty=100,UnitPrice=2.00},
                    new Products{ProductName="Apple",InstockQty=100,UnitPrice=4.00},
                    new Products{ProductName="Butter",InstockQty=100,UnitPrice=3.00},
                    new Products{ProductName="Tomato",InstockQty=100,UnitPrice=5.00 },
                ...
                OrderDetails[] detailslist = new OrderDetails[]
               {
                ...
                Orders output = context.orderDetails
                    .Where(c => c.product.ProductName == "Apple")
                    .OrderByDescending(c => c.TotalQty)
                    .Select(c => c.order)
                    .First();
                Console.WriteLine("Maximum of Apples sold in order of ");
